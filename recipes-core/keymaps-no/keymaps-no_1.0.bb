...
do_install () {
	...
	install  ${WORKDIR}/linux-keys-bare.inc ${D}${sysconfdir}/keymap/
	install  ${WORKDIR}/linux-with-alt-and-altgr.inc ${D}${sysconfdir}/keymap/
	install  ${WORKDIR}/qwerty-layout.inc ${D}${sysconfdir}/keymap/
	install  ${WORKDIR}/compose.inc ${D}${sysconfdir}/keymap/
	install  ${WORKDIR}/no.map ${D}${sysconfdir}/keymap/keymap-no.map
    fi
}
